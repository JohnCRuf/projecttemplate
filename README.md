...
This is based on Jonathan Dingel's initial project template and has been reconfigured to handle smaller projects.
...
Download the repository and compile `startup_guide/startup_guide.tex` to get started.

The following is the first page of `startup_guide.pdf` converted to Markdown.
